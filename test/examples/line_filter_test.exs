defmodule LineFilterTest do
  ...
  test "runs specs within block at line 7" do
    ESpec.Configuration.add([file_opts: [{Path.expand("./test/examples/line_filter_test.exs"), [line: 7]}]])
  ...
  test "runs specs within block at line 8" do
    ESpec.Configuration.add([file_opts: [{Path.expand("./test/examples/line_filter_test.exs"), [line: 8]}]])
  ...
  test "runs specs within block at line 10" do
    ESpec.Configuration.add([file_opts: [{Path.expand("./test/examples/line_filter_test.exs"), [line: 10]}]])
  ...
  test "runs specs within block at line 14" do
    ESpec.Configuration.add([file_opts: [{Path.expand("./test/examples/line_filter_test.exs"), [line: 14]}]])
