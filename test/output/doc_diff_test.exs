defmodule Formatters.DocDiffTest do
  ...
  test "failed start_with with diff" do
    defmodule SomeSpecStartWith do
      use ESpec
      it do: expect("string that starts with something").to start_with("string that doesnt't start with")
    end
  ...
  test "failed end_with with diff" do
    defmodule SomeSpecEndWith do
      use ESpec
      it do: expect("string that ends with something").to end_with("string that doesnt't end with")
    end
