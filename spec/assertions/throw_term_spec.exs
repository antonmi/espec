    ...
    context "Errors" do
      ...
      it "checks error with `not_to`" do
        try do
          ...
          error in [ESpec.AssertionError] ->
            expect(error.message) |> to(end_with "not to throw term, but `:some_term` was thrown.")
        end
      end
      ...
      it "checks error with `to`" do
        try do
          ...
          error in [ESpec.AssertionError] ->
            expect(error.message) |> to(end_with "to throw :another_term, but the `:some_term` was thrown.")
        end
      end
      ...
      it "checks error with `not_to`" do
        try do
          ...
          error in [ESpec.AssertionError] ->
            expect(error.message) |> to(end_with "not to throw :some_term, but the `:some_term` was thrown.")
        end
      end
      ...
      it "checks error with `not_to`" do
        try do
          ...
          error in [ESpec.AssertionError] ->
            expect(error.message) |> to(end_with "not to throw {:throw, :some, :tuple}, but the `{:throw, :some, :tuple}` was thrown.")
        end
      end
    end
  end
